...
public class GameUIManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        // S'assurer que le timer est bien arrêté au démarrage
        isTimerRunning = false;
    ...
    public void ResetTimer(float duration)
    {
        ...
        // Notez que ResetTimer NE DÉMARRE PAS le timer
        // Il faut appeler ToggleTimer(true) pour démarrer le timer
        
        Debug.Log($"Timer réinitialisé à {duration} secondes, mais pas encore démarré.");
    }
